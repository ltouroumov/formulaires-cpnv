...
\newenvironmentx{twocols}[2][1=0.5, 2=0.4]{
	...
	\renewcommand\nextcol{
		...
		\end{minipage}
		\vrule\quad
		\begin{minipage}[c]{\coltwowidth\textwidth}
		%%\vspace{0.4em}
	}
	\begin{minipage}[c]{\colonewidth\textwidth}
	%%\vspace{0.4em}
}{
	%%\vspace{0.4em}
	\end{minipage}
...
\nextcol
	\begin{tabular}{rcl}
		\formula{$a$}{Accélération} \\
		\formula{$v_0$}{Vitesse initiale} \\
	\end{tabular}
\end{twocols}

\subsection*{Mouvement Circulaire}
Mouvement d'un corps autour d'un point de rotation.
...
\nextcol
	\begin{tabular}{rcl}
		\formula{$\omega$}{Vitesse angulaire} \\
		\formula{$\theta$}{Angle} \\
		\formula{$\theta_0$}{Angle initial} \\
		\formula{$t$}{Temps} \\
	\end{tabular}
\end{twocols}
...
\nextcol
	\begin{tabular}{rcl}
		\formula{$\alpha$}{Accélération angulaire} \\
		\formula{$\omega_0$}{Vitesse angulaire initiale} \\
	\end{tabular}
\end{twocols}
